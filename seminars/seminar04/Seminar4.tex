...
\begin{document}
  ...
  % TODO: про изменение порядка в смешанном произведении
  ...
  \[
    ...
    \right.
  \]
  Тогда  % TODO: про обозначение вектрного, через крестик TODO: про векторное сам на себя
  \begin{equation*}
  \begin{split}
    \bds a \times \bds b
  ...
  Если воспользоваться полученным представлением векторного произведения через компоненты векторов, подставив его в формулу (\ref{eq:triple-as-scalar-and-vector}), то получим % TODO: check Bec: tolko li podstavit?
  \begin{equation}
  ...
  \begin{solution}
    ...
    Тогда $\bds x_0$ сонаправлен $[\bds a, \bds b]$ (векторное произведение~---~именно в таком порядке). % TODO: ref к рисунку
  ...
  \begin{solution}
    ...
    Также можно заметить, что $(\bds e_i, \bds e_i^*) \hm= 1$ и $(\bds e_i, \bds e_j^*) \hm= 0$ при $i \hm{\not=} j$ (поэтому базис $e^*$ также называют биортогональным к базису $e$). %% TODO: check Bec  TODO: pro dual v R^N
